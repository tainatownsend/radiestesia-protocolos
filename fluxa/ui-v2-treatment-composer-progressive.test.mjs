...
assert.match(complexHtml, /data-v2-treatment-draft="title"[^>]*required/,'Treatment name must expose the same required semantics enforced by the domain.');
assert.match(complexHtml, /data-v2-treatment-draft="itemLabel"[^>]*required/,'Each treatment item label is required by the domain.');
assert.match(complexHtml, /data-v2-treatment-draft="commandText"[^>]*required/,'Each treatment command is required by the domain.');
assert.match(complexHtml, /data-v2-treatment-draft="graphName"[^>]*required/,'Each treatment command needs a graph name before save.');
