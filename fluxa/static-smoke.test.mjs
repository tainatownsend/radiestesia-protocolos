...
assert.match(libraryRefinement,/data-library-tag/,'Library should expose a derived tag filter when tags exist.');
assert.match(libraryRefinement,/tagMatch/,'Library tag filter should compose with search and type filtering.');
assert.match(libraryRefinement,/function esc\(/,'Library tag labels should be escaped before HTML rendering.');
