...
'Srim','Shin','Magnetron','Neutralize','Forma Yave','Rejuvenescedor','Revitalizador dos Chakras','Liberador Espiritual','Controle de Retorno','Cruz de São Mauro','Cruz Atlante','Antakarana','Devatatta','Arcanjo Miguel','Compensador Mindtron','Escudo Mágico','Pirâmide Tao','Psico Protetor','Labirinto de Chartres','Quadrata','Turbilhão','Cruz Cósmica','Turbilhão c/ Mercúrio','Turbilhão c/ Vênus','9 Círculos','Arcanjo Rafael','Turbilhão c/ Prosperador','Escudo Bouclier','Estrela de Davi','Energizador','Desembaraçador Relacionamento/Material','Espiral Cósmica','4 Círculos','Programador Celular','Código 21','Flor da Vida','Iave','Saemju','Turbilhão com Lua','Labirinto D’Amiens','Alta Vitalidade','Luxor','Trígono Protetor','Prosperador','Desimpregnador','Scap','Triturador','Harmonia','Anti Magia','Diafragma 1','Relax Sono','Baguá','Equilíbrio','Emissor Reiki','SOS Saúde','Alfa-Omega','Anti-depress','Abundância Financeira','Tetagramaton','Turbilhão c/ Júpiter','Hiranya','Energia Divina','Cubo Metatron','Placa Keiti','Quadrado Mágico','Turbilhão com Sol','Krim','Yoshua'
]);
