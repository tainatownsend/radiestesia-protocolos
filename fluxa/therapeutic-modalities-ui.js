...
function enhance(){
 ...
 const eyebrow=main.querySelector(':scope > .eyebrow')?.textContent?.trim();
 if(eyebrow==='Tratamentos'&&!main.querySelector('[data-therapy-settings]')){const b=document.createElement('button');b.className='btn ghost small';b.dataset.therapySettings='';b.textContent='Configurar terapias';main.querySelector(':scope > .lead')?.after(b);}
