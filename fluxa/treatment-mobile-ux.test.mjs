...
const css = read('./ux-architecture-refresh.css');
...
assert.match(js, /items\.slice\(0, -1\).*setItemCollapsed/s,
  'When another treatment item is added, previous items should auto-collapse to limit scrolling.');
...
assert.match(loader, /import ['"]\.\/treatment-mobile-ux\.js['"];?/,
  'Compact treatment behavior must load through the PR #95 architecture layer.');
assert.ok(loader.indexOf("operational-pickers-ui.js") < loader.indexOf("treatment-mobile-ux.js"),
  'Treatment compacting should build on the operational searchable picker enhancement.');
