/* V1.1 quick protocols. Short session flows that reuse the consolidated controller-v4 treatment/report architecture. */
(function(){
'use strict';
...
quick_conflict_boundary:P('Limite necessário após o conflito','Clarificar limites necessários para segurança, respeito e continuidade saudável da relação ou interação.'),
quick_conflict_conversation:P('Conversa de reparação ainda necessária','Preparar uma conversa de reparação com descrição objetiva do ocorrido, impacto, necessidade, pedido e abertura para escuta.'),
quick_conflict_distance:P('Necessidade de espaço antes de nova interação','Respeitar uma pausa proporcional e, quando apropriado, definir condições para retomar a interação em vez de usar afastamento como punição.'),
quick_conflict_energy:P('Carga energética percebida após o conflito','Dentro da prática espiritual, trabalhar simbolicamente a carga energética percebida após o conflito, reforçando limites sem substituir comunicação ou medidas concretas necessárias.')
});
